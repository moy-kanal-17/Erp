...
const SingleGroup = () => {
  ...
  return (
    <motion.div
      ...
      className="bg-gray-100 min-h-screen p-6 sm:p-10"
    >
      <Card className="bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            ...
            <div className="mt-2 md:mt-0 flex items-center text-sm text-gray-500">
              {groupData.status === 'new' ? (
                <span className="px-2 py-1 rounded-full bg-yellow-100 text-yellow-800 font-medium">New</span>
              ) : (
                <span className="px-2 py-1 rounded-full bg-green-100 text-green-800 font-medium">Active</span>
              )}
            </div>
          </div>
        ...
        <div className="p-4 sm:p-6">
          ...
          >
            <Panel
              header={<h3 className="text-md font-semibold text-gray-700">Teachers</h3>}
              key="1"
              className="mb-4"
            >
            ...
            <Panel
              header={<h3 className="text-md font-semibold text-gray-700">Lessons</h3>}
              key="2"
              className="mb-4"
            >
            ...
            <Panel
              header={<h3 className="text-md font-semibold text-gray-700">Students</h3>}
              key="3"
            >
